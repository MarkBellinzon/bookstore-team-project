import{a as c,N as w}from"./vendor-eaaef1dd.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerpolicy&&(r.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?r.credentials="include":n.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();c.defaults.baseURL="https://books-backend.p.goit.global/books";async function M(e){try{const{data:t}=await c.get("/category-list",{params:{list_name:e}});return t}catch(t){console.log(t.message)}}async function S(e){try{const t=await c.get(`/category?category=${e}`);return console.log(e),t.data}catch(t){console.log(t.message)}}const T=document.querySelector(".list-categories"),y=document.querySelector("h1"),b=document.querySelector(".wrapper-categories"),C=document.querySelector(".best-categories"),$=document.querySelector(".bestseller-title");function B(e,t){const s=e.textContent.split(" "),o=s.pop(),n=s.join(" ")+` <span style="color: ${t};">${o}</span>`;e.innerHTML=n}M().then(e=>{e&&I(e)}).catch(e=>{console.log(e.message)});function I(e){const t=e.map(({list_name:o})=>`
    ...
    `).join("");b.insertAdjacentHTML("beforeend",t)}async function x(){return await c.get("https://books-backend.p.goit.global/books/top-books").then(e=>{if(!e.status)throw new Error(e.status||e.statusText);return e.data})}async function A(e){return await c.get(`https://books-backend.p.goit.global/books/category?category=${e}`).then(t=>{if(!t.status)throw new Error(t.status||t.statusText);return t.data})}function R(e){return e.map(({list_name:t,books:s})=>`<div class="category-div">
            ...
            </div>`).join("")}function v(e){return e.map(({_id:t,book_image:s,author:o,title:n})=>`<li class="book-list-top-item">
            <img
  ...
  `}function f(e){(e.key==="Escape"||e.keyCode===27)&&(m.style.display="none",document.removeEventListener("keydown",f))}const z=document.querySelector(".close-modal-btn");function D(){m.style.display="none",document.removeEventListener("keydown",f)}z.addEventListener("click",D);const u=document.getElementById("shoppingButton"),d=document.getElementById("successMessage");let p=!1;u.addEventListener("click",()=>{p?(u.textContent="Add to shopping list",d.style.display="none",p=!1):(u.textContent="Remove from the shopping list",d.textContent="Congratulations! You have added the book to the shopping list. To delete, press the button “Remove from the shopping list”.",d.style.display="block",p=!0)});fetch("https://books-backend.p.goit.global/books").then(e=>{if(!e.ok)throw new Error("Network response was not ok");return e.json()}).then(e=>{updateModalContent(e)}).catch(e=>{console.error("There has been a problem with your fetch operation:",e)});const h={LIGHT:"light-theme",DARK:"dark-theme"},l=document.querySelector("body"),i=document.querySelector(".js-switch-theme");i.addEventListener("click",F);function F(e){e.currentTarget.checked?(l.classList.add("dark-theme"),localStorage.setItem("saveTheme",h.DARK),i.checked=!0):(l.classList.remove("dark-theme"),localStorage.setItem("saveTheme",h.LIGHT),i.checked=!1)}const K=localStorage.getItem("saveTheme");K===h.LIGHT?(l.classList.remove("dark-theme"),i.checked=!1):(l.classList.add("dark-theme"),i.checked=!0);
//# sourceMappingURL=dark-theme-787904ec.js.map
